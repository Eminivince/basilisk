...
/// Embedded vuln-reasoning system prompt — `vuln_v2.md`, current
/// default. Broader-scope vulnerability hunting with mandatory
/// structured-recording discipline. Operators can override via
